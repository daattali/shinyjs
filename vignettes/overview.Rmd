...
and many more useful functions. You can [check out a demo Shiny app](http://daattali.com/shiny/shinyjs-demo/) that lets
...
First we need to set the form to be resettable by wrapping its UI in a call to `resettable`
