...
You can also write your own JavaScript functions and use `shinyjs` to call
them as if they were regular R code - read more about that in the section 
...
### `extendShinyjs` example

To continue with the previous example, here are the steps required to add your
own function that you can call to change the colour of an HTML element:
...
TODO documentation not finished
      ...
      runApp(shinyApp(
        ui = fluidPage(
          useShinyjs(),
          extendShinyjs("tests/test-success.js"),
