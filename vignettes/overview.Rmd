...
- `shinyjs` includes a `colourInput` which is an input control that allows
...
- [Video of my `shinyjs` talk](http://bit.ly/shinyjs-2016-shinydevcon) and the associated [presentation slides](http://bit.ly/shinyjs-slides) from the 2016 Shiny Developer Conference.
